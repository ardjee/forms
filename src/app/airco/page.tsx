...
import { AircoContractForm } from '@/components/AircoContractForm';
import {
  Card,
  CardContent,
  CardDescription,
...
export default function ServiceAircoPage() {
  return (
            ...
            <Card className="w-full max-w-4xl shadow-lg">
              ...
              <CardHeader className="text-center">
                ...
                <CardTitle className="font-headline text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                  Inschrijfformulier Onderhoudsabonnement Airco
                </CardTitle>
                <CardDescription className="text-muted-foreground text-base/relaxed max-w-3xl mx-auto pt-4 text-left space-y-3">
                  <p>
                    ...
                    onze onderhoudsabonnementen voor airconditioning. Goed onderhoud zorgt voor een optimale werking en een langere levensduur van uw installatie.
                  </p>
