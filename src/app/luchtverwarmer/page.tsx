...
import { LuchtverwarmerContractForm } from '@/components/LuchtverwarmerContractForm';
import {
  Card,
  CardContent,
  CardDescription,
...
export default function ServiceLuchtverwarmerPage() {
  return (
            ...
            <Card className="w-full max-w-4xl shadow-lg">
              ...
              <CardHeader className="text-center">
                ...
                <CardTitle className="font-headline text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                  Inschrijfformulier Onderhoudsabonnement Luchtverwarmer
                </CardTitle>
                <CardDescription className="text-muted-foreground text-base/relaxed max-w-3xl mx-auto pt-4 text-left space-y-3">
                  <p>
                    Met dit formulier kunt u zich direct inschrijven voor een onderhoudsabonnement voor uw luchtverwarmer. Goed onderhoud is essentieel voor een duurzame en efficiënte werking van uw systeem.
                  </p>
                  <p>Vul de onderstaande gegevens zo volledig mogelijk in.</p>
                </CardDescription>
              </CardHeader>
              <CardContent>
                <LuchtverwarmerContractForm />
              </CardContent>
            </Card>
          </div>
        </div>
