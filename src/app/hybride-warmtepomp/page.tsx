...
import { HybrideWarmtepompContractForm } from '@/components/HybrideWarmtepompContractForm';
import {
  Card,
  CardContent,
  CardDescription,
...
export default function ServiceHybrideWarmtepompPage() {
  return (
            ...
            <Card className="w-full max-w-4xl shadow-lg">
              ...
              <CardHeader className="text-center">
                ...
                <CardTitle className="font-headline text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                  Inschrijfformulier Onderhoudsabonnement Hybride Warmtepomp
                </CardTitle>
