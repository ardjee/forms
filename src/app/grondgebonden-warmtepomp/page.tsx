...
import { GrondgebondenWarmtepompContractForm } from '@/components/GrondgebondenWarmtepompContractForm';
import {
  Card,
  CardContent,
  CardDescription,
...
export default function ServiceGrondgebondenWarmtepompPage() {
  return (
            ...
            <Card className="w-full max-w-4xl shadow-lg">
              ...
              <CardHeader className="text-center">
                ...
                <CardTitle className="font-headline text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                  Inschrijfformulier Onderhoudsabonnement Grondgebonden Warmtepomp
                </CardTitle>
              ...
              <CardContent>
                <GrondgebondenWarmtepompContractForm />
              </CardContent>
            </Card>
          </div>
        </div>
