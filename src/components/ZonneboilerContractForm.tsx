...
// Prijzen per combinatie van frequentie en type abonnement voor Zonneboiler
...
export function ZonneboilerContractForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      await verwerkWarmtepompContract({ ...values, maandelijksePrijs: maandelijksePrijs || 0 }, 'zonneboiler');
      toast({
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Card>
            <CardHeader><CardTitle>Gegevens Zonneboiler</CardTitle></CardHeader>
