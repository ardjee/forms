...
// Prijzen per combinatie van frequentie en type abonnement voor Warmte-Terugwin-Unit
...
export function WarmteRugwinUnitContractForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      await verwerkWarmtepompContract({ ...values, maandelijksePrijs: maandelijksePrijs || 0 }, 'warmte-terugwin-unit');
      toast({
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Card>
            <CardHeader><CardTitle>Gegevens Warmte-Terugwin-Unit (WTW-unit)</CardTitle></CardHeader>
