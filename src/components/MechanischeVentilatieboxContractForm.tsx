...
export const formSchema = z.object({
  ...
  // Gegevens mechanische ventilatiebox
...
// Prijzen per combinatie van frequentie en type abonnement voor Mechanische ventilatiebox
...
export function MechanischeVentilatieboxContractForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      await verwerkWarmtepompContract({ ...values, maandelijksePrijs: maandelijksePrijs || 0 }, 'mechanische-ventilatiebox');
      toast({
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Card>
            <CardHeader><CardTitle>Gegevens Mechanische Ventilatiebox (MV-box)</CardTitle></CardHeader>
                ...
                {maandelijkeKosten !== null && (
                  <div className="pt-4 border-t">
                    <div className="flex justify-between items-center">
                      <span className="text-lg font-semibold">Maandelijkse kosten:</span>
                      <span className="text-2xl font-bold text-primary">€{maandelijkeKosten.toFixed(2).replace('.', ',')}</span>
                    </div>
                  </div>
                )}
            </CardContent>
