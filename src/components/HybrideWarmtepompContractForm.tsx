...
export const formSchema = z.object({
  ...
  systeemType: z.enum(["grondgebonden", "hybride", "all-electric"]).default("hybride"),
...
// Prijzen per combinatie van frequentie en type abonnement voor Hybride warmtepomp
...
export function HybrideWarmtepompContractForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      await verwerkWarmtepompContract({ ...values, maandelijksePrijs: maandelijksePrijs || 0 }, 'warmtepomp-hybride');
      toast({
