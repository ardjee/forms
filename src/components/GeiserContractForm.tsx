...
export const formSchema = z.object({
  ...
  onderhoudsfrequentie: z.enum(["12"], { required_error: "Kies een onderhoudsfrequentie." }),
...
// Prijzen per combinatie van frequentie en type abonnement voor Geiser
...
export function GeiserContractForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      await verwerkWarmtepompContract({ ...values, maandelijksePrijs: maandelijksePrijs || 0 }, 'geiser');
      toast({
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Card>
            <CardHeader><CardTitle>Gegevens Geiser</CardTitle></CardHeader>
