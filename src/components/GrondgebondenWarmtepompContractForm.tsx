...
export const formSchema = z.object({
  ...
  systeemType: z.enum(["grondgebonden", "hybride", "all-electric"]).default("grondgebonden"),
...
// Prijzen per combinatie van frequentie en type abonnement voor Grondgebonden warmtepomp
...
export function GrondgebondenWarmtepompContractForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      await verwerkWarmtepompContract({ ...values, maandelijksePrijs: maandelijksePrijs || 0 }, 'warmtepomp-grondgebonden');
      toast({
        ...
        <Card>
            ...
            <CardContent className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Monitoring Warmtepomp</FormLabel>
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        <FormControl>
                          <SelectTrigger>
                ...
                <FormField control={form.control} name="akkoordVoorwaarden" render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 pt-4">
                        ...
                        <div className="space-y-1 leading-none">
                            <FormLabel>Hierbij ga ik akkoord met de <a href="/ZON_ECNI_Abelenco_ServiceAbon_voorwaarden.pdf" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Algemene Voorwaarden Onderhoudsabonnement Warmtepomp</a></FormLabel>
                            <FormDescription>
