...
export const formSchema = z.object({
  ...
  onderhoudsfrequentie: z.enum(["12", "18"], { required_error: "Kies een onderhoudsfrequentie." }),
...
// Prijzen per combinatie van frequentie en type abonnement voor Gasboiler
...
const berekenMaandelijkeKosten = (
  ...
  return basisPrijs + voorrijdkostenKosten;
};

export function GasboilerContractForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      await verwerkWarmtepompContract({ ...values, maandelijksePrijs: maandelijksePrijs || 0 }, 'gasboiler');
      toast({
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Card>
            <CardHeader><CardTitle>Gegevens Gasboiler</CardTitle></CardHeader>
