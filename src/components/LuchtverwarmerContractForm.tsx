...
// Prijzen per combinatie van frequentie en type abonnement voor Luchtverwarmer
...
export function LuchtverwarmerContractForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      await verwerkWarmtepompContract({ ...values, maandelijksePrijs: maandelijksePrijs || 0 }, 'luchtverwarmer');
      toast({
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Card>
            <CardHeader><CardTitle>Gegevens Luchtverwarmer</CardTitle></CardHeader>
